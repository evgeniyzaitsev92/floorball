...
<!-- ТУТ ХЭДЭР -->
    ...
    <form id="search_by_vendor_code_form" method="GET" class="">
        <label id="search_by_vendor_code"><input id="search_by_vendor_code_input" type="number" name="search_by_vendor_code"
                                                     placeholder="Поиск по артикулу"></label>
        <button id="search_by_vendor_code_btn" type="submit" disabled>Загрузить</button>
    ...
    <form method="POST" enctype="multipart/form-data" class="d-flex flex-dir-col">
        <!-- Тип товара -->
        <label>Тип товара
        ...
        <!-- Артикул --> <label id="p_vendor_code">Артикул<input id="p_vendor_code_input" type="number" name="vendor_code" placeholder="Обязательное поле!"></label>
                         <label hidden id="p_vendor_code_warning">АРТИКУЛ ЗАНЯТ!</label>
        <!-- Наименование --> <label id="p_name">Наименование<input id="p_name_input" type="text" name="name" readonly></label>
        <!-- Тип для карточки --> <label id="p_type_card">Тип для карточки<input id="p_type_card_input" type="text" name="type_card"></label>
        <!-- Товарный знак --> <label id="p_brand">Товарный знак<input id="p_brand_input" type="text" name="brand"></label>
        <!-- Марка --> <label id="p_trademark">Марка<input id="p_trademark_input" type="text" name="trademark"></label>
        <!-- Модель --> <label id="p_model">Модель<input id="p_model_input" type="text" name="model"></label>
        <!-- Спецификация --> <label id="p_spec">Спецификация<input id="p_spec_input" type="text" name="spec"></label>
        <!-- Индекс жёсткости -->
        <label hidden id="p_rigid">Индекс жёсткости, мм
        ...
        <!-- Цвет --> <label id="p_color">Цвет<input id="p_color_input" type="text" name="color"></label>
        <!-- Серия --> <label id="p_series">Серия<input id="p_series_input" type="text" name="series"></label>
        <!-- Профиль рукоятки --> <label hidden id="p_handle">Профиль рукоятки<input id="p_handle_input" type="text" name="handle"></label>
        <!-- Материал рукоятки --> <label hidden id="p_handle_mat">Материал рукоятки<input id="p_handle_mat_input" type="text" name="handle_mat"></label>
        <!-- Длина -->
        <label hidden id="p_length">Длина, см
        ...
        <!-- Вес --> <label id="p_weight">Вес<input id="p_weight_input" type="number" step="0.001" name="weight"></label>
        <!-- Цена --> <label id="p_price">Цена<input id="p_price_input" type="number" step="0.001" name="price"></label>
        <!-- Скидка --> <label id="p_discount">Скидка<input id="p_discount_input" type="number" step="0.001" name="discount"></label>
        <!-- Цена со скидкой --> <label id="p_price_with_discount">Цена со скидкой<input id="p_price_with_discount_input" type="number" step="0.001" name="price_with_discount" readonly></label>
        <!-- Наличие на складе --> <label id="p_stock_status">Наличие на складе<input id="p_stock_status_input" type="text" name="stock_status"></label>
        <!-- Группа --> <label id="p_group">Группа<input id="p_group_input" type="text" name="group" readonly></label>
        <!-- Описание --> <label id="p_desc">Описание<textarea id="p_desc_input" name="desc"></textarea></label>
        <!-- Фото -->
        <div class="d-flex flex-dir-col">Фото
            <div class="images-container d-grid"></div>
            <button type="button" class="add-img"><span>Добавить</span></button>
        </div>

        <!-- СОХРАНИТЬ КАРТОЧКУ -->
        <button id="save_card_btn" type="submit" name="save_card" disabled>Сохранить</button>
        ...
        <script>
            ...
            function addImgItem(editMode, pathToFile){
                ...
                jQuery('.images-container').append(`
                    <div class="d-flex flex-dir-col">
                        <label for="p_images_input`+String(idNum)+`">Выбрать файл</label>
                        ...
                        <img hidden src="" id="p_images_img`+String(idNum)+`" class="p_images_common d-flex">
                        <button type="button" class="del-img"><span>Удалить</span></button>
                    </div>`);
            ...
            jQuery('.images-container').on('click', '.del-img', function(){
            ...
            function composeNameAndGroup(){
                ...
                let p_grab = ', '+document.querySelector('input[type=radio][name="grab"]:checked').value;

                document.getElementById('p_name_input').value = p_type+p_type_card+p_brand+p_trademark+p_model+p_rigid+p_color+p_length+p_grab;
